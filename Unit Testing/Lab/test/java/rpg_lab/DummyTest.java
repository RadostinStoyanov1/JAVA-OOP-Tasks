...
public class DummyTest {
    ...
    @Test
    public void test_Dummy_LoosesHealth_When_Alive_And_Attacked() {
        dummy.takeAttack(ATTACK);
        Assert.assertEquals(HEALTH - ATTACK, dummy.getHealth());
    }
    ...
    public void test_Dummy_GivesExperience_WhenDead() {
        ...
        Assert.assertEquals(EXPERIENCE, actualXp);
    }
    ...
    @Test
    public void test_Dummy_IsAliveWhenHealth_IsPositive() {
